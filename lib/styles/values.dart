...
abstract class Values {
  ...
  static const urlPrivacyPolicy = "https://hablo-app.web.app/privacy";
  static const urlTerms = "https://hablo-app.web.app/terms";
}

enum LanguageLevel {
  beginner(0.1, description: "langBeginner"),
  elementary(0.25, description: "langElementary"),
  intermediate(0.5, description: "langIntermediate"),
  advanced(0.8, description: "langAdvanced"),
  proficient(1, description: "langProficient");

  final double percentage;
  final String description;

  const LanguageLevel(this.percentage, {required this.description});
}
